...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const API_URL = 'http://localhost:8000/api/quiz'; // Full URL with port
    ...
    fetch('http://localhost:8000/')
        ...
        .catch(error => {
            console.error('⚠️ API server not responding. Make sure main.py is running on port 8000');
            alert('Warning: Backend server is not running. Please start the Python server (main.py) on port 8000.');
        });
});